...
public class UI {
    ...
    public UI(GamePanel gp) {
        ...
        try {
            ...
            is = new FileInputStream("Resources/Font/Purisa Bold.ttf");
    ...
    public void drawCharacterScreen() {
        ...
        final int y = gp.tileSize;
        final int width = gp.tileSize * 5;
        final int height = gp.tileSize * 10;
        drawSubWindow(x, y, width, height);
    ...
    public void drawOptionsScreen() {
        ...
        switch(subState) {
            ...
            case 3: options_exitGameConfirmation(frameX, frameY); break;
        }
    ...
    public void options_exitGameConfirmation(int frameX, int frameY) {
